            ...
            TextButton(
              ...
              onPressed: () {
                ...
                if(formKey.currentState!.validate() && _newChatNameController.text.isNotEmpty && addPeopleYesOrNo.contains(true)){
                  ...
                  const ChatPage(receiverUserName: "dummyEmail@gmail.com", receiverUserIDs: ["dum1234"], chatRoom: "Requires New ID.",)),);
                }
        ...
        itemBuilder: (context, index) {
          return ListTile(
            ...
            onTap: () {
              ...
              Navigator.push(context, MaterialPageRoute(builder: (context) =>
                  ChatPage(receiverUserName: "dummyEmail@gmail.com", receiverUserIDs: ["dum1234"], chatRoom: groupChatUniqueIDs[index],)));
            },
